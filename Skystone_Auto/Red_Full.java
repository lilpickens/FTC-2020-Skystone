...
@Autonomous(name= "Red_Test", group="Sky autonomous")
//@Disabled//comment out this line before using
public class Red_Full extends LinearOpMode {
    ...
    private static float[] midPos = {4.5f/8f+offsetX, 6.2f/8f+offsetY};//0 = col, 1 = row
    private static float[] leftPos = {2f/8f+offsetX, 6.2f/8f+offsetY};
    private static float[] rightPos = {7f/8f+offsetX, 6.2f/8f+offsetY};
        ...
        while (opModeIsActive()) {
            ...
            if (valLeft == 0 && opState == 0) {
                ...
                if (opState == 1 && opModeIsActive()) { //drive over to the first stone
                    driveLRTest(-975, 0.35, 3, 0, 3);
                    sleep(100);
                    driveSBTest(-400, 0.3, 5, 0, 3);
                    sleep(100);
                    opState++;
                }
                ...
                if (opState == 9 && opModeIsActive()) {
                    turnTestTest(-110, 0.3, 2);
                    sleep(10);
                    driveSBTest(700, 0.4, 20, -110, 2.5);
                    sleep(100);
                    opState++;
                }
                if (opState == 10 && opModeIsActive()) {
                    turnMoreTestTest(90, 0.5, 3); //just trust past me plz
                    sleep(100);
                    opState++;
                }
                if (opState == 11 && opModeIsActive()) {
                    driveSB2Test(-200, 0.3, 20, 90, 1);
                    sleep(100);
                    robot.foundation_New1.setPosition(robot.foundationNew1Up);
                    robot.foundation_New2.setPosition(robot.foundationNew2Up);
                    opState++;
                ...
                if (opState == 12 && opModeIsActive()) {
                    driveLR2Test(350, 0.4,  20, 90, 1.5);
                    sleep(100);
                    opState++;
                }
                if (opState == 13 && opModeIsActive()) { //drive to lz to the 6th position
                    ...
                    driveSB2Test(3200, 0.7, 10, 90, 5); //slower
                    sleep(100);
                    opState++;
                }
                if (opState == 14 && opModeIsActive()) { //scoot to  block
                    driveLR2Test(525, 0.2, 5, 90, 3.5);
                    sleep(10);
                    robot.intakeMotors.setPower(-1);
                    robot.intakeCollector.setPower(-0.8);
                    driveSB2Test(200, 0.3, 5, 90, 2);
                    sleep(10);
                    driveLR2Test(-525, 0.3, 5, 90, 3.5);
                    sleep(10);
                    opState++;
                }
                if (opState == 15 && opModeIsActive()) { //drive to foundation
                    driveSB2Test(-2700, 0.8, 10, 90, 3.5); //slower
                    sleep(100);
                ...
                if (opState == 13 && opModeIsActive()) { //drive to lz to the 6th position
                    robot.arm.setPosition(robot.armStore);
                    robot.grabber.setPosition(robot.aGrabberClosedFull);
                    driveSB2Test(2850, 0.7, 10, 90, 5); //slower
                    sleep(100);
                    opState++;
                }
                if (opState == 14 && opModeIsActive()) { //scoot to  block
                    driveLR2Test(600, 0.2, 5, 90, 3.5);
                    sleep(10);
                    robot.intakeMotors.setPower(-1);
                    robot.intakeCollector.setPower(-0.8);
                    driveSB2Test(200, 0.3, 5, 90, 2);
                    sleep(10);
                    driveLR2Test(-600, 0.3, 5, 90, 3.5);
                    sleep(10);
                    opState++;
                }
                if (opState == 15 && opModeIsActive()) { //drive to foundation
                    driveSB2Test(-2500, 0.8, 10, 90, 3.5); //slower
                    sleep(100);
                    robot.intakeMotors.setPower(0);
                    robot.intakeCollector.setPower(0);
                    opState++;
                ...
                if (opState == 13 && opModeIsActive()) { //drive to lz to the 6th position
                    robot.arm.setPosition(robot.armStore);
                    robot.grabber.setPosition(robot.aGrabberClosedFull);
                    driveSB2Test(2625, 0.7, 10, 90, 5); //slower
                    sleep(100);
                    opState++;
                }
                if (opState == 14 && opModeIsActive()) { //scoot to  block
                ...
                if (opState == 15 && opModeIsActive()) { //drive to foundation
                    driveSB2Test(-2375, 0.8, 10, 90, 3.5); //slower
                    sleep(100);
                    robot.intakeMotors.setPower(0);
                    robot.intakeCollector.setPower(0);
                    opState++;
    ...
    public void driveSB2Test (double duration, double speedPercent, double error, double heading, double time) {
        double position = robot.back_right.getCurrentPosition();
        double target = position + duration;
        double distanceToTargetStart = Math.abs(target - position);
        double distanceToTarget = target - position;
        ...
        double speed = 0;
        double[] wheelSpeed = new double[4]; //fl, fr, bl, br
        double turnSpeed = ((heading - ((getAbsoluteHeading()+270)%360))/20);
        double startTime = getRuntime();
        ...
        while (Math.abs(distanceToTarget) > error && !isStopRequested() && getRuntime() < startTime + time) {
            ...
            turnSpeed = -((heading - ((getAbsoluteHeading()+270)%360))/40);
    ...
    public void driveLR2Test (double duration, double speedPercent, double error, double heading, double time) {
        double position = robot.back_right.getCurrentPosition();
        double target = position + duration;
        double distanceToTargetStart = Math.abs(target - position);
        double distanceToTarget = target - position;
        ...
        while (Math.abs(distanceToTarget) > error && !isStopRequested() && getRuntime() < startTime + time) {
            ...
            turnSpeed = -((heading - ((getAbsoluteHeading()+270)%360))/35);
    ...
    public void turnMoreTestTest (double target, double speedPercent, double error) {
        double DaS = Math.abs(target - ((getAbsoluteHeading()+270)%360));
        double distance = target - ((getAbsoluteHeading()+270)%360);
        double percent = distance/DaS;
        ...
        while (Math.abs(distance) > error && !isStopRequested()) {
            distance = target - ((getAbsoluteHeading()+270)%360);
            percent = distance/DaS;
