...
@Autonomous(name="Red_Foundation_Outside", group="14174")
//@Disabled
public class Red_BZ_Outside extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //drivetrain = new MecanumDrivetrain(new DcMotor[] {front_left, robot.front_right, robot.back_left, robot.back_right});
        ...
        robot.foundation_New1.setPosition(.3);
        robot.foundation_New2.setPosition(.7);
        ...
        while (opModeIsActive()) {
            ...
            if (opState == 1 && opModeIsActive()) {
                ...
                sleep(1000);
                robot.foundation_New1.setPosition(.8);
                robot.foundation_New2.setPosition(0.22);
                sleep(1000);
                opState++;
            }
